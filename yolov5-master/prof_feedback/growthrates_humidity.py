...
if __name__ == "__main__":
    ...
    humidities = [row[1] for row in weather_data]
    ...
    ax1.plot(dates, humidities, marker='o', color=color, label='Average Humidity')
    ...
    fig.tight_layout()
    plt.title('Average Humidity and Growth Rate Changes Over Time')
