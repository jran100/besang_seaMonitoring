...
if __name__ == "__main__":
    ...
    water_temperatures = [row[1] for row in weather_data]
    ...
    color = 'tab:blue'
    ax1.set_xlabel('Date')
    ax1.set_ylabel('Average Water Temperature', color=color)
    ax1.plot(dates, water_temperatures, marker='o', color=color, label='Average Water Temperature')
    ...
    fig.tight_layout()
    plt.title('Average Water Temperature and Growth Rate Changes Over Time')
