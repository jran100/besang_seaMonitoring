...
if __name__ == "__main__":
    ...
    pressures = [row[1] for row in weather_data]
    ...
    color = 'tab:blue'
    ax1.set_xlabel('Date')
    ax1.set_ylabel('Average Pressure', color=color)
    ax1.plot(dates, pressures, marker='o', color=color, label='Average Pressure')
    ...
    fig.tight_layout()
    plt.title('Average Pressure and Growth Rate Changes Over Time')
