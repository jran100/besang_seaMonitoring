...
if __name__ == "__main__":
    ...
    wind_speeds = [row[1] for row in weather_data]
    ...
    color = 'tab:blue'
    ax1.set_xlabel('Date')
    ax1.set_ylabel('Average Wind Speed', color=color)
    ax1.plot(dates, wind_speeds, marker='o', color=color, label='Average Wind Speed')
    ...
    fig.tight_layout()
    plt.title('Average Wind Speed and Growth Rate Changes Over Time')
